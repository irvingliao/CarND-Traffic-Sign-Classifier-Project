...
- Could not load 'msvcp140.dll'. TensorFlow requires that this DLL be
  ...
  try:
    ...
    candidate_explanation = True
    print("""
- Could not load 'cudart64_90.dll'. The GPU version of TensorFlow
  requires that this DLL be installed in a directory that is named in
  your %PATH% environment variable. Download and install CUDA 9.0 from
...
- Could not load 'cudnn64_7.dll'. The GPU version of TensorFlow
  ...
  if not cudnn7_found or not cudnn6_found:
    print()
    if not cudnn7_found and not cudnn6_found:
